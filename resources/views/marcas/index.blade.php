...
<div class="card">
    ...
    <div class="card-body ">
        ...
        <div class="row p-3">
            <div class="col-6 texto-esquerda">
                <button class="btn btn-my-primary form-button " type="button"
                    onclick="window.location.href='/marcas/create'">Adicionar</button>
            </div>
        ...
        <div class="row p-3 ">
            <div class="col-12 ">
                <form class="" action="{{ route('marcas.pesquisa') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <input class="form-control me-2 mx-2" type="search" name="pesquisa"
                        placeholder="Pesquisar por Marca" aria-label="Search">
