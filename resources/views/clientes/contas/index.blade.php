...
<div class="card">
    <div class="card">
        <div class="card-header">
            <div class="row ">
                <div class="col-sm-6 esquerda titulo fw-media uppercase">
                    Compras Realizadas | <span class=" fw-small-x ">Lista
                    </span>
                </div>
                <div class="col-sm-6 direita">
                    <span>{{$cliente['nome']}}</span> </b></span>
                </div>
            </div>
        </div>
        <div class="card-body ">
            ...
            <div class="row p-3">
                ...
                <div class="col-6 texto-direita">
                    <button class="btn btn-my-primary form-button" type="button" onclick="window.location.href='/clientes/itenscompras/{{ $cliente->id }}'">
                        <img class="mx-1" src="{{ env('APP_LINK_IMAGES') }}carrinho.png" width="18px" height="18px">
                        Mostrar Itens de Compras
                    </button>
                    <button class="btn btn-my-primary form-button" type="button" onClick="javascript:window.open('{{ route('relatorios.contacliente', ['id' => $cliente->id,'status' => $filtros->status,'dtini'=>$filtros->dtini,'dtfim'=>$filtros->dtfim]) }}', '_blank');">
                        <img class="mx-1" src="{{ env('APP_LINK_IMAGES') }}printconsolidado.png" width="18px" height="18px">
                        Imprimir Compras Consolidado
                    </button>
                    <button class="btn btn-my-primary form-button" type="button" onClick="javascript:window.open('{{ route('relatorios.contaclientedetalhado', ['id' => $cliente->id,'status'=>$filtros->status,'dtini'=>$filtros->dtini,'dtfim'=>$filtros->dtfim])}}', '_blank');">
                        <img class="mx-1" src="{{ env('APP_LINK_IMAGES') }}detail.png" width="18px" height="18px">
                        Imprimir Compras Detalhadas
                    </button>
                </div>
        ...
        <script>
            function pegastatus() {
                return document.getElementByName("status").value;
            }
        </script>
